...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#FDF1CE] py-8 px-4 flex flex-col items-center justify-center border-t border-[#008000]/10 font-sans">
      <div className="max-w-2xl w-full text-center space-y-5">
        
        {/* ─── BARIS 1: IKON MEDIA SOSIAL (MENGGUNAKAN SVG AMAN) ─── */}
        <div className="flex items-center justify-center gap-5">
          ...
          <a 
            ...
            className="w-12 h-12 rounded-full bg-[#008000] text-[#FDF1CE] flex items-center justify-center hover:bg-[#006400] transition-colors shadow-sm p-3"
        ...
        {/* ─── BARIS 3 ─── */}
        <div className="flex flex-wrap justify-center items-center gap-x-2 gap-y-1 text-[11px] md:text-xs text-[#008000]/70 font-medium max-w-lg mx-auto">
          <a href="#privacy" className="hover:underline">Privacy Policy</a>
          <span>|</span>
          <a href="#cookies" className="hover:underline">Cookie Consent Tool</a>
          <span>|</span>
          <a href="#terms" className="hover:underline">Terms of Use</a>
          <span>|</span>
          <a href="#sitemap" className="hover:underline">Site Map</a>
          <span>|</span>
          <a href="#about" className="hover:underline">About Pleco Project</a>
        </div>
